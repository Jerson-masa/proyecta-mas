...
export function IndividualPanel({ user, onLogout }: { user: any; onLogout: () => void }) {
  const [activeTab, setActiveTab] = useState<'courses' | 'my-courses'>('courses');
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-6 pb-20">
        <div className="max-w-md mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-white mb-1">Mis Cursos</h1>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white/10 backdrop-blur-sm rounded-[20px] p-4">
              <div className="text-white/80 mb-1">Cursos Completados</div>
              <div className="text-white">{user.completedCourses || 0}</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-[20px] p-4">
              <div className="text-white/80 mb-1">En Progreso</div>
              <div className="text-white">{enrollments.filter(e => !e.completed).length}</div>
            </div>
          </div>
        </div>
      </div>
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex gap-2 flex-wrap mb-4">
                      ...
                      <span className="px-3 py-1 bg-gray-100 text-gray-600 rounded-[12px]">
